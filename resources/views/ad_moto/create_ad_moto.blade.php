...
<div class="container">
    ...
    <form id="msform">
        <!-- progressbar -->
        <ul id="progressbar">
            <li class="active">Datos del Anuncio</li>
            <li>Imagenes del Vehiculo</li>
            <li>Tipo de Anuncio</li>
            <li>Fin del Proceso</li>
        </ul>
        <!-- fieldsets -->
        <fieldset>
            <h2 class="fs-title">Datos del Vehiculo</h2>
        ...
        <fieldset>
            <h2 class="fs-title">Datos Test 2</h2>
            <h3 class="fs-subtitle">Original data</h3>
