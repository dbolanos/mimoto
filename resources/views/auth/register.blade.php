            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            <label for="first_surname" class="col-md-4 col-form-label text-md-right">{{ __('Primer Apellido') }}</label>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="phone" type="text" class="form-control" name="phone" placeholder="8888-5555" value="" required>
                        ...
                        <div class="form-group row">
                            <label for="canton" style="color:black" class="col-md-4 col-form-label text-md-right">{{ __('Cantón') }}</label>

                            <div class="col-md-6">
                                <select id="canton"  style="border: 2px solid #555" class="form-control" name="canton">
                        ...
                        <div class="form-group row">
                            <label for="district" style="color:black" class="col-md-4 col-form-label text-md-right">{{ __('Distrito') }}</label>

                            <div class="col-md-6">
                                <select id="district"  style="border: 2px solid #555" class="form-control" name="district">
